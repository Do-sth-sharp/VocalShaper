...
class AudioSendComponent final
...
private:
	...
	std::unique_ptr<juce::Drawable> channelIcon = nullptr;
	std::unique_ptr<juce::DrawableButton> channelButton = nullptr;
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(AudioSendComponent)
};
